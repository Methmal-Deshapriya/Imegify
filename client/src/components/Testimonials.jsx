...
const Testimonials = () => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="flex flex-col items-cover justify-center my-20 py-12 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 "
    >
      ...
      <div className="flex flex-wrap gap-4 max-w-4xl mx-auto ">
        {testimonialsData.map((testimonail, index) => (
          <div
            key={index}
            className="bg-white/20 p-6 rounded-lg shadow-md order w-60 m-auto hover:scale-[1.02] transition-all"
          >
